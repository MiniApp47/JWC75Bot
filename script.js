      ...
      products: [
         {
          ...
          image: "ProductBP.jpg",
          video: "VideoBP.mp4",
          description:" Filtre X3🍫⛰️🇲🇦\n DHF FARMS/ 120u premium\n Saison 2026",
          tarifs: [
            { weight: "10g", price: 60.0 },
            { weight: "20g", price: 110.0 },
        ...
        },
        {
          ...
          image: "ProductC.jpg",
          video: "VideoC.mp4",
          description:" Dry-sift / 90u ✅local-river",
          tarifs: [
            { weight: "10g", price: 50.0 },
            { weight: "20g", price: 100.0 },
            { weight: "50g", price: 250.0 },
        ...
        {
          id: "120u_blacktruffle_cbd",
          flag: "🇨🇭",
          name: "🧆 BLACK TRUFFLE",
          farm: "🍫🇨🇭SWISS-FARMS🇨🇭⛰️",
          promoEligible: true,
          type: "Filtre/Dry",
          image: "Product120B.jpg",
          video: "Video120M.mp4",
          description:
            "— 120u/45u 🔬 \n\n 🧬 Sélection Premium Swiss-Farms\n🥣 Terpènes intenses & texture parfaite",
          tarifs: [
      ...
      products: [
         {
          id: "🫒OliveF Frozen 🧊⚡️",
          flag: "🧊",
          name: "🫒OliveF Frozen 🧊⚡️",
          farm: "🧬 Marocan Valley ⛰️",
          promoEligible: true,
          type: "Frozen",
          image: "ProductOFF.jpg",
          video: "VideoOFF.mp4",
          description: "",
          tarifs: [
            { weight: "0,5 🫒", price: 70.0 },
            { weight: "1 🫒", price: 120.0 },
            { weight: "2 🫒", price: 240.0 },
            { weight: "5 🫒", price: 550.0 },
            { weight: "10 🫒", price: 900.0 },
          ],
        },
        {
          id: "🫒OliveR Frozen 🧊⚡️",
          flag: "🧊",
          name: "🫒OliveR Frozen 🧊⚡️",
          farm: "🧬 Marocan Valley ⛰️",
          promoEligible: true,
          type: "Frozen",
          image: "ProductOF.jpg",
          ...
          image: "ProductL.jpg",
          video: "VideoL.mp4",
          description: "🧊🍫Frozen-🥶🧬 220/90u",
          tarifs: [
            { weight: "5g", price: 70.0 },
            { weight: "10g", price: 120.0 },
            { weight: "25g", price: 290.0 },
    ...
    // ============================================================
    {
      ...
      products: [
        ...
        },
        {
          ...
          images: ["ProductGP.jpg", "ProductBL.jpg", "ProductCM.jpg"],
          ...
          jars: [
            ...
            },
            {
              name: "BLUE LOBSTER",
              emoji: "🔵🦞🏆",
              colorClass: "style-passion",
            },
            { name: "GIRAFE PUZZY", emoji: "🦒🧩", colorClass: "style-brown" },
          ],
          tarifs: [
            { weight: "5g", price: 130.0, oldPrice: 180.0 },
            { weight: "10g", price: 260.0, oldPrice: 300.0 },
            { weight: "20g", price: 450.0, oldPrice: 600.0 },
            { weight: "50g", price: 1100.0, oldPrice: 1350.0 },
          ],
        },
        /*  {
          id: "🧬⚡️PIATELLA🍯💣",
          ...
          description: "",
          tarifs: [
            { weight: "️5g", price: 130.0 },
            { weight: "10g", price: 250.0 },
            { weight: "25g", price: 450.0 },
            { weight: "50g", price: 1100.0 },
            { weight: "100g", price: 1900.0 },
          ],
        }, */
      ],
    },
    ...
    // ============================================================
    {
      ...
      products: [
        ...
        },
        {
          ...
          promoEligible: true,
          type: "Weed",
          image: "ProductAmne2.jpg",
          video: "VideoAmne2.mp4",
          description: "",
          tarifs: [
            { weight: "6g", price: 50.0 },
            { weight: "12g", price: 100.0 },
            { weight: "50g", price: 300.0 },
            { weight: "100g", price: 500.0 },
          ],
        },
      ...
      products: [
        {
          ...
          video: "VideoWC.mp4",
          description:
            "🧬Top-Shelf 🥇 \n Acidulé avec des saveurs terreuses 🌳et poivrées . Cette délicieuse friandise 🍭 d'une variété doit être appréciée avec une double dose de soins🛌 en raison de sa teneur extrêmement 🌡️élevée en THC 😵‍💫",
          tarifs: [
            { weight: "5g", price: 50.0 },
            { weight: "10g", price: 100.0 },
      ...
      products: [
        {
          ...
          tarifs: [
            ...
            { weight: "3g", price: 150.0 },
            { weight: "4g", price: 200.0 },
